 const Welcome = () => {
     return (
         <div>
            ...
            <p><b>To Use:</b></p>
            <ol>
                <li>Click <b>Enter New Trade</b></li>
                <li>Enter the details of the trade, including:<br />
                Security Ticker Symbol<br />
                Date of Trade <br />
                Strategy user for this trade *** This is most important, as the way to learn to trade is to document what you're doing to make a profit.<br />
                You can choose a strategy that you have perviously used from the dropdown menu, or you click "New Strategy" and enter a new strategy.  </li>
                Also enter the amount of profit or loss (enter losses with a negative number) from the trade outcome.
            </ol>
